...
INSERT INTO employees (EmployeeId, PrimaryLocationId, ReportsToEmployeeId, FirstName, LastName, Email, Phone, PositionTitle, Salary, HireDate, Status, Active, ManagerId) VALUES
                                                                                                                                                                              ...
                                                                                                                                                                              (4, 1, NULL, 'David', 'Support', 'david.support@email.com', '403-444-0000', 'Support Agent', 50000.00, '2023-07-01', 'Active', 1, NULL),
                                                                                                                                                                              (5, 1, NULL, 'Ethan', 'Sales', 'ethan.sales@email.com', '403-555-0000', 'Senior Sales Agent', 65000.00, '2023-08-01', 'Active', 1, NULL),
                                                                                                                                                                              (6, 2, NULL, 'Fiona', 'Warehouse', 'fiona.warehouse@email.com', '403-666-0000', 'Warehouse Staff', 48000.00, '2023-09-01', 'Active', 1, NULL),
                                                                                                                                                                              (7, 2, NULL, 'George', 'Logistics', 'george.logistics@email.com', '403-777-0000', 'Logistics Coordinator', 52000.00, '2023-10-01', 'Active', 1, NULL),
